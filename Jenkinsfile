        ...
        stage('Clone') {
            steps {
                timeout(time: 2, unit: 'MINUTES'){
                    git branch: 'main', credentialsId: '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', url: 'https://github.com/JhendersonAaron/test.git'
                }
            }
        }
        stage('Build') {
