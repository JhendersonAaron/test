        ...
        stage('Clone') {
            steps {
                timeout(time: 2, unit: 'MINUTES'){
                    git branch: 'main', credentialsId: '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', url: 'https://github.com/JhendersonAaron/test.git'
                }
            }
        }
        stage('Build') {
